		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					data-toggle="collapse" href="#collapseUsers"
					data-parent="#exampleAccordion"> <i class="fa fa-users"
						aria-hidden="true"></i> <span class="nav-link-text">Users</span>
				</a>

					<ul class="sidenav-second-level collapse" id="collapseUsers">
						<li><a href="main.cacao?page=user/add"> <i
								class="fa fa-user-plus" aria-hidden="true"></i> User Add
						</a></li>
						<li><a href="user.cacao?page=userlist&cmd=list"><i
								class="fa fa-list-ul" aria-hidden="true"></i> User List</a></li>
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					href="#collapseProducts" data-parent="#exampleAccordion"> <i
						class="fa fa-shopping-cart" aria-hidden="true"></i> <span
						class="nav-link-text">Product</span>
				</a>

					<ul class="sidenav-second-level collapse" id="collapseProducts">
						<li><a href="main.cacao?page=product/add"><i
								class="fa fa-cart-plus" aria-hidden="true"></i> Product Add</a></li>
						<li><a href="product.cacao?cmd=list"><i
								class="fa fa-list-ul" aria-hidden="true"></i> Product List</a></li>
					</ul></li>


				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Weather"><a class="nav-link"
					href="main.cacao?page=weather"> <i class="fa fa-cloud"
						aria-hidden="true"></i> <span class="nav-link-text">Weather</span>
				</a></li>

				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Charts"><a class="nav-link" href="main.cacao?page=criminal">
	...
	<footer class="sticky-footer">
		<div class="container">
			<div class="text-center">
				<small>Eileen Kim Website 2018</small>
			</div>
		</div>
	</footer>
